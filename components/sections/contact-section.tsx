        ...
        <div className="grid gap-12 xl:grid-cols-[0.75fr_1.25fr] xl:gap-16 xl:items-start">
          ...
          <div>
            {contactInfo.map((info, index) => (
              ...
              >
                <span className="text-[0.7rem] font-semibold uppercase tracking-[0.13em] text-stone-400 dark:text-stone-500">
                  {info.title}
                </span>
                {info.href ? (
                  <Link
          ...
          >
            {isSubmitted ? (
              ...
              >
                <CheckCircle className="h-14 w-14 text-sky-700 dark:text-sky-100" />
            ...
            <div className="rounded-xl border border-destructive/30 bg-destructive/10 px-4 py-3 text-sm text-destructive">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-48 rounded-[1.2rem] border-stone-950/10 bg-white/82 text-stone-950 placeholder:text-stone-500 dark:border-white/10 dark:bg-black/24 dark:text-stone-100 dark:placeholder:text-stone-500"
                  />
                </div>
