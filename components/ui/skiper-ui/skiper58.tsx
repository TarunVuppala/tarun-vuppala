...
const letterClassName = "inline-block leading-none"
...
const TextRoll: React.FC<{
  ...
  return (
    <motion.span
      ...
      className={cn(
        "relative block w-fit max-w-full leading-none no-underline",
        hovered ? "overflow-hidden" : "overflow-visible",
        className,
      )}
      style={hovered ? { clipPath: "inset(0)" } : undefined}
    >
      ...
      <span
        className={cn(
          "absolute inset-0 flex whitespace-nowrap",
